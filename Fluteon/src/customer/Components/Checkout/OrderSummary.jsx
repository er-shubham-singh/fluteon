...
// const [couponDiscount, setCouponDiscount] = useState(0); // e.g., ₹200
// const { user } = useSelector((state) => state.auth); // assuming you have user info here
...
// if (isLoadingOrder || !order || !order.totalDiscountedPrice || !order.orderItems) {
//   return (
...
//               <span className="text-green-700">
//                 ₹
//                 {order.order?.totalDiscountedPrice - discountAmount >= 0
//                   ? order.order?.totalDiscountedPrice - discountAmount
//                   : 0}
//               </span>
//             </div>
//           </div>
