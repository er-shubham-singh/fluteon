...
// import { applyCoupon, allCoupon } from "../../../Redux/Customers/Coupon/couponActions";
...
//   const cartTotal = cart.cart.totalDiscountedPrice; // ✅ send totalDiscountedPrice
...
//                   <span className="text-green-700">-₹{coupon.difference}</span>
//                 </div>
//               )}
...
//             {/* Coupon Input & Available List */}
//             <div className="mt-6 border rounded-lg bg-gray-50 shadow-md p-4 space-y-4">
...
//                   className="border rounded-md px-3 py-2 w-full md:w-[70%] focus:outline-blue-500"
//                 />
//                 <Button
//                   variant="contained"
...
//                 <div className="bg-white rounded-md border p-3 space-y-2 max-h-48 overflow-y-auto">
//                  {showAvailableCoupons && availableCoupons.length > 0 && (
//   <div className="bg-white rounded-md border p-3 space-y-3 max-h-64 overflow-y-auto">
//     {availableCoupons.map((c) => (
//       <div
//         key={c._id}
//         className="flex flex-col md:flex-row md:items-center md:justify-between border-b pb-3 last:border-b-0"
//       >
//         <div className="flex flex-col gap-1">
//           <p className="font-semibold text-sm uppercase">{c.code}</p>
