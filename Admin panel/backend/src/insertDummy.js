...
//     sizes: [
//       { label: "28", waist: 28, length: 38 },
//       { label: "30", waist: 30, length: 39 },
//       { label: "32", waist: 32, length: 40 },
//       { label: "34", waist: 34, length: 41 },
//       { label: "36", waist: 36, length: 42 }
//     ]
//   },
//   {
//     category: "cotton_pants",
//     sizes: [
//       { label: "28", waist: 28, length: 37 },
//       { label: "30", waist: 30, length: 38 },
//       { label: "32", waist: 32, length: 39 }
//     ]
//   },
//   {
...
//     // await SizeChart.deleteMany(); // Optional
//     await sizeChart.insertMany(dummySizeCharts);

//     console.log("✅ Dummy size charts inserted");
//     process.exit();
//   })
//   .catch((error) => {
